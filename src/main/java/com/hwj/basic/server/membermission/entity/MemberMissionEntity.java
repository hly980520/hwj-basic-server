package com.hwj.basic.server.membermission.entity;
...
@TableName(value = "member_mission", autoResultMap = true)
public class MemberMissionEntity implements Serializable {

    private static final long serialVersionUID = 985110034701607158L;
    ...
    public String toString() {
        return new StringJoiner(", ", MemberMissionEntity.class.getSimpleName() + "[", "]")
                .add("id=" + id)
